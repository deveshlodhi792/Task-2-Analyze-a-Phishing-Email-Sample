...
To identify the phishing characteristics of email, we have to start with examining the Sender's email:-
  ...
  - It suggests that the email is not from the authentic website.
  - The sender here trying masquerade technique.
  - The Display name term "ServiceStatus" which is improper formatting or typo, it also a strong indicator or potential phishing attacker.
